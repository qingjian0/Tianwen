    ...
    <PageLayout>
      <div className="space-y-12">
        ...
        >
          ...
          <p className="text-xl text-text-secondary font-kai mb-6">星曜神术</p>
          ...
          >
            ...
            <Card header="星曜排列">
              <div className="grid grid-cols-2 sm:grid-cols-4 md:grid-cols-6 gap-4">
                {[
                  ...
                  >
                    <div className="text-imperial-gold font-song font-semibold text-lg">
                      {star}
                    </div>
            ...
            <Card header="简要解读">
              <div className="space-y-4 text-text-secondary font-kai leading-relaxed">
                <p>
                  <span className="text-imperial-gold font-song font-semibold">
                    命宫分析：
                  </span>
