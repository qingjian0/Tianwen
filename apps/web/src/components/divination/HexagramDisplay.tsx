...
const LINE_TEXT = {
  ...
  3: {
    yang: "九三：君子终日乾乾，夕惕若厉，无咎。",
    yin: "六三：含章可贞。或从王事，无成有终。",
  },
        ...
        <Card variant="default">
          <div className="flex items-center justify-between mb-4">
            ...
            <div className="flex items-center gap-2">
              <span className="text-xs text-text-muted font-kai">
                第{hexagram.number}卦
              </span>
              <span className="text-gold font-song font-bold text-xl">
                {hexagram.name}
              </span>
            </div>
          </div>
                  ...
                  >
                    ...
                    >
                      {line.isYang ? (
                        ...
                        >
                          <div
                            className={`w-16 h-2 rounded-sm will-change-transform-opacity ${line.isChanging ? "bg-primary" : "bg-gold"}`}
                          />
                        </motion.div>
                      ) : (
                        <motion.div
                        ...
                        >
                          <div
                            className={`w-7 h-2 rounded-sm will-change-transform-opacity ${line.isChanging ? "bg-primary" : "bg-gold"}`}
                          />
                          <div
                            className={`w-7 h-2 rounded-sm will-change-transform-opacity ${line.isChanging ? "bg-primary" : "bg-gold"}`}
                          />
          ...
          <div className="flex justify-center gap-8">
            <div className="text-center">
              ...
              <div className="text-sm font-kai text-text-secondary">
                {upper.name}
              </div>
          ...
          {changingLine && changingLine >= 1 && changingLine <= 6 && (
            ...
            >
              <div className="text-sm font-kai text-primary-light mb-2">
                动爻 · 第{changingLine}爻
              </div>
              <div className="text-text-secondary text-sm">
                {(() => {
                  const changingLineData = lines.find(
                    (l) => l.number === changingLine,
                  );
                  if (!changingLineData) return "";
                  const lineText =
                    LINE_TEXT[changingLine as keyof typeof LINE_TEXT];
      ...
      <Card variant="default">
        ...
        {expandedDetail && (
          <motion.div
            ...
            className="pt-4"
          >
            <div className="text-text-primary font-song mb-4">
              {hexagram.description}
            </div>
            <div className="text-text-secondary text-sm leading-relaxed font-kai">
              <p className="mb-3">
                此卦象征{hexagram.name}，代表{upper.element}与{lower.element}
                的相互作用。
            ...
            <div className="relative w-48 h-48">
              <svg viewBox="0 0 200 200" className="w-full h-full">
                ...
                <motion.circle
                  ...
                  className={
                    upper.element === "木" ? "opacity-100" : "opacity-40"
                  }
                  animate={
                    upper.element === "木"
                      ? {
                ...
                <motion.circle
                  ...
                  r="15"
                  fill={
                    upper.element === "火" || lower.element === "火"
                      ? "#DC143C"
                      : "#DC143C"
                  }
                  className={
                ...
                <motion.circle
                  ...
                  r="15"
                  fill={
                    upper.element === "土" || lower.element === "土"
                      ? "#DAA520"
                      : "#DAA520"
                  }
                  className={
                ...
                <motion.circle
                  ...
                  r="15"
                  fill={
                    upper.element === "水" || lower.element === "水"
                      ? "#4169E1"
                      : "#4169E1"
                  }
                  className={
                ...
                <motion.circle
                  ...
                  r="15"
                  fill={
                    upper.element === "金" || lower.element === "金"
                      ? "#C0C0C0"
                      : "#C0C0C0"
                  }
                  className={
