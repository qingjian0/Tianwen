...
const JIEQI_LONGITUDE = [
  315, 330, 345, 0, 15, 30, 45, 60, 75, 90, 105, 120, 135, 150, 165, 180, 195,
...
const JIEQI_DATA: Record<number, number[]> = {
  2024: [
    4, 19, 5, 20, 4, 19, 5, 20, 5, 21, 6, 21, 7, 22, 7, 22, 8, 22, 8, 23, 7, 22,
    21, 20,
  ],
  2025: [
    3, 18, 5, 20, 4, 20, 5, 21, 5, 21, 6, 21, 7, 22, 7, 23, 8, 23, 8, 23, 7, 22,
    21, 20,
  ],
};
