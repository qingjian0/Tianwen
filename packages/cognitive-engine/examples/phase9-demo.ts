...
async function main() {
  ...
  console.log(
    "八字:",
    baziResult.ganzhi.year,
    baziResult.ganzhi.month,
    baziResult.ganzhi.day,
    baziResult.ganzhi.hour,
  );
  ...
  console.log(
    "紫微:",
    ziweiResult.mainPalace.name,
    ziweiResult.mainPalace.mainStars[0],
  );
  ...
  const historyResult = await temporalMemory.queryTimeline({
    userId: "demo-user",
  });
